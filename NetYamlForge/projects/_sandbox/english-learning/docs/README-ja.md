...
dotnet run -- --scaffold-entities --project=english-learning

# 2. ブラウザで確認
# → http://localhost:5000/english-learning
# → http://localhost:5000/english-learning/Dashboard
```
...
navigation:
  items:
    - label: My Page
      url: /english-learning/Page/MyPage
      icon: 📋
```
...
| フックを追加したい | `dotnet run -- --scaffold-hook --name=MyHook --project=english-learning` |
