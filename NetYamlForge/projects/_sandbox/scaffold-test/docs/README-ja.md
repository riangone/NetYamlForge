...
dotnet run -- --scaffold-entities --project=scaffold-test

# 2. ブラウザで確認
# → http://localhost:5000/scaffold-test
# → http://localhost:5000/scaffold-test/Dashboard
```
...
| フックを追加したい | `dotnet run -- --scaffold-hook --name=MyHook --project=scaffold-test` |
