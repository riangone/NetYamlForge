# AI Card (AI Handshake Protocol PoC)
...
dotnet run -- --scaffold-entities --project=ai-card

# 2. ブラウザで確認
# → http://localhost:5000/ai-card
# → http://localhost:5000/ai-card/Dashboard
```
...
| フックを追加したい | `dotnet run -- --scaffold-hook --name=MyHook --project=ai-card` |
