...
dotnet run -- --scaffold-entities --project=blog

# 2. ブラウザで確認
# → http://localhost:5000/blog
# → http://localhost:5000/blog/Dashboard
```
...
| フックを追加したい | `dotnet run -- --scaffold-hook --name=MyHook --project=blog` |
