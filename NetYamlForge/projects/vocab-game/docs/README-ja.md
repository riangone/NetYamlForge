...
dotnet run -- --scaffold-entities --project=vocab-game

# 2. ブラウザで確認
# → http://localhost:5000/vocab-game
# → http://localhost:5000/vocab-game/Dashboard
```
...
| フックを追加したい | `dotnet run -- --scaffold-hook --name=MyHook --project=vocab-game` |
