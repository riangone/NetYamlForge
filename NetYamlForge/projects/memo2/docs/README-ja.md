...
dotnet run -- --scaffold-entities --project=memo2

# 2. ブラウザで確認
# → http://localhost:5000/memo2
# → http://localhost:5000/memo2/Dashboard
```
...
| フックを追加したい | `dotnet run -- --scaffold-hook --name=MyHook --project=memo2` |
