...
dotnet run -- --scaffold-entities --project=ai-doc-processor

# 2. ブラウザで確認
# → http://localhost:5000/ai-doc-processor
# → http://localhost:5000/ai-doc-processor/Dashboard
```
...
navigation:
  items:
    - label: My Page
      url: /ai-doc-processor/Page/MyPage
      icon: 📋
```
...
| フックを追加したい | `dotnet run -- --scaffold-hook --name=MyHook --project=ai-doc-processor` |
