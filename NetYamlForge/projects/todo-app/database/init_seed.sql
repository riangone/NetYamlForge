-- ============================================================
-- todo-app database initialization script (with test data)
-- ============================================================
-- Usage:
--   sqlite3 database/todo-app.db < database/init_seed.sql
-- Note: Drops and recreates Category, Project, Task, Comment tables.
...
-- Project 2 – API v2 Migration (Id=2)
INSERT INTO Task (Title, Status, Priority, ProjectId, CategoryId, DueDate, Description, AssignedTo, Tags, EstimatedHours, ActualHours, CompletedAt) VALUES
...
-- Project 4 – Data Warehouse (Id=4, on_hold)
INSERT INTO Task (Title, Status, Priority, ProjectId, CategoryId, DueDate, Description, AssignedTo, Tags, EstimatedHours, ActualHours, CompletedAt) VALUES
...
-- Project 6 – Docs Portal (Id=6, completed)
INSERT INTO Task (Title, Status, Priority, ProjectId, CategoryId, DueDate, Description, AssignedTo, Tags, EstimatedHours, ActualHours, CompletedAt) VALUES
...
-- No-project tasks (standalone, Id=NULL)
INSERT INTO Task (Title, Status, Priority, ProjectId, CategoryId, DueDate, Description, AssignedTo, Tags, EstimatedHours, ActualHours, CompletedAt) VALUES
