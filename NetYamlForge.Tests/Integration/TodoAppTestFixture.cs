// ファイル概要: todo-app プロジェクトの E2E テスト用ファクトリです。
...
public sealed class TodoAppTestFixture : WebApplicationFactory<Program>
{
    public const string ProjectName = "todo-app";
    ...
    public TodoAppTestFixture()
    {
        ...
        TempContentRoot = Path.Combine(Path.GetTempPath(), "nyf-todo-app-e2e", Guid.NewGuid().ToString("N"));
