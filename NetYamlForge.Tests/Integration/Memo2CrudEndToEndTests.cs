// ファイル概要: memo2 の memo CRUD E2E テストです。
// --ai-scaffold によって自動生成されました（手動調整版）。
...
public class Memo2CrudEndToEndTests : IClassFixture<Memo2TestFixture>
{
    private const string IndexUrl = "/memo2/DynamicEntity/Index?entity=memo";
    private const string CreateUrl = "/memo2/DynamicEntity/Create?entity=memo";

    private static readonly Regex AntiForgeryTokenRegex = new(
        "name=\"__RequestVerificationToken\"[^>]*value=\"([^\"]+)\"",
        RegexOptions.Compiled);

    private readonly Memo2TestFixture _fixture;

    public Memo2CrudEndToEndTests(Memo2TestFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async Task EditMemo_ChangesTitle_Succeeds()
    {
        ...
        var editUrl = $"/memo2/DynamicEntity/Edit?entity=memo&id={id}";
    ...
    public async Task DeleteMemo_RemovesRecord()
    {
        ...
        var deleteUrl = $"/memo2/DynamicEntity/Delete?entity=memo&id={id}";
    ...
    public async Task SearchMemo_ByTitle_ReturnsMatchingResults()
    {
        ...
        var searchUrl = $"/memo2/DynamicEntity/ListPartial?entity=memo&search={searchNs}-alpha&count=true";
