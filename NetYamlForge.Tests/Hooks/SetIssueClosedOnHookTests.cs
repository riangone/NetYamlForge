// 責務: SetIssueClosedOnHook のユニットテスト。
...
public class SetIssueClosedOnHookTests
{
    // ─── ヘルパー ───────────────────────────────────────────
    ...
    {
        var sut = new SetIssueClosedOnHook(
            Microsoft.Extensions.Logging.Abstractions.NullLogger<SetIssueClosedOnHook>.Instance);
    ...
    public void Name_IsCorrectYamlKey()
    {
        var sut = new SetIssueClosedOnHook(
            Microsoft.Extensions.Logging.Abstractions.NullLogger<SetIssueClosedOnHook>.Instance);
        Assert.Equal("set_issue_closed_on", sut.Name);
    }
}